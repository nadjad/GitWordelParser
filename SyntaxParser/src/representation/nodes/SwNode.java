...
import support.CaseItem;

public class SwNode extends Node {
	...
	public SwNode(List<String> inList, String condPort, List<CaseItem> cases) {
		super(null, null);
		...
		for (String in : inList) {
			...
			c.addDestination(new ConnectionEnd(this.id, in));
